...
export const ContainerScrollImage = ({
  titleComponent,
  children,
}: {
...
export const CardImage = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-8 mx-auto h-[25rem] md:h-[35rem] w-full border-4 border-[#6C6C6C] p-0 bg-[#222222] rounded-[30px] shadow-2xl overflow-hidden"
    >
      {children}
    </motion.div>
  );
